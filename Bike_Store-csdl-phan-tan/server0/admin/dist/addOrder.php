                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <form action="xulithemOrder.php" method="get" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="inputtenbaihat">Order id:</label>
                                  <input type="text" class="form-control" name ="id" placeholder="input id Order ">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name ="discount" placeholder="input discount">
                                </div>
                                <div class="form-group">
                                    <label for="selectalbum">Product id:</label>
