                    ...
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            <div class="card-header">
                                ...
                                Table Order
                                <a href="addOrder.php"  class="btn btn-info">Add Order</a>
                            </div>
                            ...
                            <div >
                                ...
                                <div class="table-responsive">
                                    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                                        ...
                                        <?php 
                                            $sqlSelect = "SELECT * FROM sales_order_items";
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    <a href="editOrder.php?id=<?php echo $row['item_id'] ?>">
                                                        <i class="fas fa-edit"></i>
                                                    </a>
                                                    <a href="delOrder.php?id=<?php echo $row['item_id'] ?>">
