...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="index.php">Product Manage</a>
                ...
                <main>
                    <div class="container-fluid">
                        ...
                        <div class="card mb-4">
                            ...
                            <div class="card-body">
                            <form action="xulithemproduct.php" method="get" enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="inputtenbaihat">Product id:</label>
                                  <input type="text" class="form-control" name ="id" placeholder="input id product ">
                                </div>
                                <div class="form-group">
                                    <label for="inputtencasi">Product name:</label>
                                  <input type="text" class="form-control" name ="name" placeholder="input name product">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <input type="text" class="form-control" name ="sl" placeholder="input quantity">
                                </div>
                                <div class="form-group">
